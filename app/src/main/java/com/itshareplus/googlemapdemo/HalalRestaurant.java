...
public class HalalRestaurant extends AppCompatActivity implements OnMapReadyCallback, DirectionFinderListener {
    ...
    public void checkResult(final Integer distance) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (d < 81) {
                // Click action
                Intent intent = new Intent(HalalRestaurant.this, musafirresult_fail.class);
                //intent.putExtra("Long_Distance", distance);
                startActivity(intent);

                }else{
                    Intent intent = new Intent(HalalRestaurant.this, MusafirResultActivity.class);
                    //intent.putExtra("Long_Distance", distance);
                    startActivity(intent);
                }
            }
